"""
Django settings for appointment_calendar project.
...
SECRET_KEY = 'django-insecure-5#ig3acl9s!68dokxet6wqj(8)7(c!glw-e7cb*i&4y55zw4x!'
...
WSGI_APPLICATION = 'appointment_calendar.wsgi.application'
