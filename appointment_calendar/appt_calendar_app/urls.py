...
urlpatterns = [    
    ...
    path('business/appearance/<int:account_id>/', views.BusinessAppearanceView.as_view(), name='business_appearance'),
    ...
    path('events/delete_photos/', views.delete_photos, name='delete_event_business_photos'),
